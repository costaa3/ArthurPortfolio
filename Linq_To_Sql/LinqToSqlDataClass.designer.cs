...
namespace Linq_To_Sql
{
    ...
    partial void DeleteUniversity(University instance);
		...
		public LinqToSqlDataClassDataContext() : 
				base(global::Linq_To_Sql.Properties.Settings.Default.masterConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Lecture_StudentLecture", Storage="_StudentLectures", ThisKey="Id", OtherKey="StudentId")]
    ...
    partial void OnLectureIdChanged();
		...
		public int StudentId
		{
			...
			set
			{
				...
				{
					if ((this._Lecture.HasLoadedOrAssignedValue || this._Student.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Lecture_StudentLecture", Storage="_Lecture", ThisKey="StudentId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
